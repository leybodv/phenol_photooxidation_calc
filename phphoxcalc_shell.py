...
class PhPhOxCalcShell(cmd.Cmd):
    ...
    def do_addcalibration(self, arg):
        ...
        arguments = self.parse_args(arg)
        self.calibrations.append(Calibration(solute=arguments['solute'], solvent=arguments['solvent'], calibration_wavelength=arguments['calibration_wavelength'], calibration_folder=arguments['calibration_folder'])
